...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> newlist(String labelid, Integer page, Integer rows){
	 ...
	 * @return
	 */
	public Page<Problem> hotlist(String labelid, Integer page, Integer rows){
		Pageable pageable = PageRequest.of(page - 1,rows );
	 ...
	 * @return
	 */
	public Page<Problem> waitlist(String labelid, Integer page, Integer rows){
		Pageable pageable = PageRequest.of(page - 1,rows );
